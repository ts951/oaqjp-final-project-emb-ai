...
def detect_emotion():
    ...
    # If dominant_emotion is None then display invalid text message to user
    ...
    'disgust': {emotion_data['disgust']}, 'fear': {emotion_data['fear']}, \
    'joy': {emotion_data['joy']}, and 'sadness': {emotion_data['sadness']}. \
